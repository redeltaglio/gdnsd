...
F_NONNULL
static bool zscan_do(ltree_node_t* zroot, const uint8_t* origin, const char* fn, const unsigned def_ttl_arg)
{
...
bool zscan_rfc1035(ltree_node_t* zroot, const char* fn)
{
